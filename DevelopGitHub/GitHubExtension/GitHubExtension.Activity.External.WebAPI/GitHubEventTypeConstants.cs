namespace GitHubExtension.Activity.External.WebAPI
{
    static class GitHubEventTypeConstants
    {
        ...
        public const string DownloadEvent = "DownloadEvent";
        public const string FollowEvent = "FollowEvent";
        public const string ForkEvent = "ForkEvent";
        public const string ForkApplyEvent = "ForkApplyEvent";
        public const string GistEvent = "GistEvent";
